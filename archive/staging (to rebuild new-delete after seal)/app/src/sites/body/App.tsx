...
const LiveMetric: React.FC<{
  ...
  color?: string;
}> = ({ label, value, unit, trend = 'stable', color = '#00d4aa' }) => {
  return (
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setMetrics({
        ...
        entropy: 0.03 + Math.random() * 0.02,
        reversibility: 99.5 + Math.random() * 0.5,
        omega: 0.035 + Math.random() * 0.01,
      });
    }, 2000);
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-[#00d4aa]/50 flex items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="px-3 py-1 rounded-lg bg-[#00d4aa]/10 border border-[#00d4aa]/30">
              ...
              <span className="ml-1 font-bold">{metrics.omega.toFixed(3)}</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="py-8 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <LiveMetric 
              label="Reversibility" 
              value={metrics.reversibility.toFixed(1)} 
              unit="%" 
              trend="stable"
            />
            <LiveMetric 
              label="Quantum σ" 
              value={metrics.omega.toFixed(3)} 
              unit="" 
              trend="stable"
              color="#ff6b35"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-[#0f1418] border border-[#00d4aa]/20">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-xs text-[#00d4aa]/60">
                  31 nodes • 4 levels
                </div>
              </div>
              <MerkleTree />
      ...
      <section className="py-8 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="p-4 rounded-xl bg-[#ff6b35]/10 border border-[#ff6b35]/30 flex items-center gap-4">
            ...
            <ChevronRight className="w-5 h-5 text-[#ff6b35]/50" />
          </div>
        </div>
      </section>
