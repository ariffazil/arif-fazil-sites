...
- A2A (Agent2Agent)  
  ...
  - Focuses on cross‑agent discovery, authentication, task lifecycle and monitoring, not on IDEs or single‑agent tool use. [solo](https://www.solo.io/topics/ai-infra/what-is-a2a)
